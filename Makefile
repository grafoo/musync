#############################################################################
# Makefile for building: musync
# Generated by qmake (3.0) (Qt 5.6.1)
# Project:  musync.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile musync.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = musync1.0.0
DISTDIR = /home/mgf/src/musync/.tmp/musync1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: musync.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
